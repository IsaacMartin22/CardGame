...
public class EventScreen implements Screen {
    ...
    public EventScreen(final TheGameClass game) {
        this.game = game;
        ...
        Image backgroundImage = new Image(game.assets.get("backgrounds/autumn_orange_background.png", com.badlogic.gdx.graphics.Texture.class));
